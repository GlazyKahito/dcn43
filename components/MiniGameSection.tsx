  ...
  return (
    <section id="minigame" className="scroll-mt-24 max-w-7xl mx-auto px-4 sm:px-6 py-14 space-y-8">
      ...
      <div className="text-center space-y-3 max-w-3xl mx-auto">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#c8b27a]/15 border border-[#c8b27a]/30 text-[#c8b27a] font-display text-xs uppercase tracking-widest">
